...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(700, 465)
        ...
        self.inp_data_nascimento.setStyleSheet(
            "color: \'#333A44\'; padding: 4px; margin-bottom: 10px; font-size: 10pt;")
        ...
        self.btn_registro.setStyleSheet(
            " padding: 10px; background-color: \'#00C569\'; border: none; color: \'#ffffff\';")
