...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.inp_numero_conta.setValidator(self.onlyInt)
        ...
        self.inp_valor_d.setValidator(self.onlyInt)
        ...
        font.setFamily("Calibri")
        font.setPointSize(10)
        self.inp_numero_conta_d.setFont(font)
        self.inp_numero_conta_d.setStyleSheet("color: \'#333A44\'; padding: 4px; margin-bottom: 10px;")
        ...
        self.inp_numero_conta_t.setValidator(self.onlyInt)
        ...
        self.inp_valor_t.setValidator(self.onlyInt)
        ...
        self.inp_valor_s.setValidator(self.onlyInt)
        ...
        self.nome_cliente = self.usuario[0]
    ...
    def sacar(self):
        ...
        try:
            ...
            if float(saldo) < 0:
                ...
                valor_atual = float(saldo) - float(valor)

                sacar(numero_conta, valor_atual)

                self.label_18.setText(sacar_ok)
            else:
                self.label_18.setText(saldo_fail)
        except:
            print(sacar_fail)
        finally:
            saldo = get_saldo(numero_conta)
    ...
    def depositar(self):
        ...
        try:
            ...
            depositar(numero_conta, valor_atual)
    ...
    def transferir(self):
        valor = self.inp_valor_t.text()
        numero_conta_envia = int(self.inp_numero_conta.text())
        numero_conta_recebe = int(self.inp_numero_conta_t.text())

        try:
            saldo_envia = get_saldo(numero_conta_envia)
            valor_envia = float(saldo_envia) - float(valor)

            saldo_recebe = get_saldo(numero_conta_recebe)
            valor_recebe = float(saldo_recebe) + float(valor)

            transferir(numero_conta_envia, numero_conta_recebe, valor_envia=valor_envia, valor_recebe=valor_recebe)
            ...
            saldo = get_saldo(numero_conta_envia)
            self.inp_valor_s.setText('')
            self.lbl_saldo_atual.setText(str(saldo))
            self.lbl_mensagem.setText(f"Saldo atual {saldo}")
