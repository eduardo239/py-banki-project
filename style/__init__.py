btn_green = "padding: 10px; background-color: '#00C569'; border: none; color: '#ffffff';"
btn_disabled = "padding: 10px; background-color: '#BFCCB8'; border: none; color: '#54695A';"

# label
lbl_title_green = "color: '#00C569'; padding: 4px 0; margin-bottom: 10px; font-size: 18pt; " \
                  "font-family: 'Roboto Mono';"
lbl_small_grey = "color: '#333A44'; font-size: 10pt; " \
                 "font-family: 'Calibri';"
lbl_mensagem_default = "color: '#333A44'; padding: 14px 10px;"
lbl_mensagem_error = "padding: 14px 10px; color: #721c24; background-color: #f8d7da; " \
